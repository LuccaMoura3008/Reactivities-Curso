...
public class DbInitializer
{
    ...
    {
        if (context.Activities.Any()) return; //Para checar se há alguma atividade no banco de dados
        ...
        context.Activities.AddRange(activities); //Esta apenas rastreando esssas informacoes na memoria, nada no Banco ate o momento

        await context.SaveChangesAsync(); //Aqui de fato salva no banco de dados
    }
}
